    ...
    return (
        <div className="min-h-screen bg-[#f8f9fa]">
            ...
            <div className="max-w-[1600px] mx-auto w-full flex flex-col lg:flex-row lg:gap-8 lg:p-8 lg:pt-8 p-4 sm:p-6">
                ...
                <aside className="hidden lg:block w-72 flex-shrink-0 self-start sticky z-20 transition-all duration-300 pt-4" style={{ top: 'var(--header-offset, 112px)' }}>
                ...
                <main className="flex-1 min-w-0">
                    ...
                    <div className="lg:sticky z-30 lg:bg-[#f8f9fa] lg:pb-4 lg:pt-4 transition-all duration-300" style={{ top: 'var(--header-offset, 112px)' }}>
                        {/* Search Header */}
